const products = [
    ...
    },
    {
        ...
        price: 1200,
        category: "Librería",
        description: "El magicobard A4 es idea lpara la facultad, viene con un block de notas con puntillado de 50 hojas de 100g y un sobre interno para guardar papeles, además tiene un elástico para poner la lapicera (magic clip) . MAGICBOARD : 235*216mm. BLOCK A4  : 210*294 cm.",
        stock: 6,
    ...
    },
    {
        ...
        price: 2150,
        category: "Librería",
        description: "Caja con visor ( para ver los distintos diseños). 5 unidades de 10mm*3m",
        stock: 16,
